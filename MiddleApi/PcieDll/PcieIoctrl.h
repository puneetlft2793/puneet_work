#ifndef _LFT_PCI_IOCTL_H_
#define _LFT_PCI_IOCTL_H_
...
#define IOCTL_LFT_SPPU_REG_RD CTL_CODE (FILE_DEVICE_UNKNOWN,   \
									0x020,                 \
									METHOD_BUFFERED,       \
									FILE_ANY_ACCESS)

#define IOCTL_LFT_SPPU_REG_WR CTL_CODE (FILE_DEVICE_UNKNOWN,   \
                                    0x021,                 \
                                    METHOD_BUFFERED,       \
                                    FILE_ANY_ACCESS)
#endif // _LFT_PCI_IOCTL_H_
